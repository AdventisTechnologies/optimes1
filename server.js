...
// MongoDB connection
mongoose.connect( mongodb_url||'mongodb+srv://srmrmpparthiban:20a8yW18xd48XYJ9@cluster0.vviu6.mongodb.net/optimus', { useNewUrlParser: true, useUnifiedTopology: true })
  .then(() => {
    const db = mongoose.connection;
    const changeStream = db.collection('EmployeeData').watch();
    console.log('Change stream set up for EmployeeData');
