...
app.use(express.static(path.join(__dirname, 'dist', 'optimuspage')));

// Catch all route to send index.html for any route (important for Angular routing)
app.get('*', (req, res) => {
  res.sendFile(path.join(__dirname, 'dist', 'optimuspage', 'index.html'));
});  
